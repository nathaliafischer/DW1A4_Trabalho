...
jQuery.extend(jQuery.validator, {
	 ...
	 */
	messages: {
		required: "Informa&ccedil;&atilde;o obrigat&oacute;ria.",
		email: "Por favor, entre com um e-mail v&aacute;lido.",
		url: "Please enter a valid URL.",
		date: "Por favor, insira uma data v&aacute;lida.",
		dateISO: "Please enter a valid date (ISO).",
		dateDE: "Bitte geben Sie ein gültiges Datum ein.",
		number: "Por favor, entre com um n&uacute;mero v&aacute;lido.",
		numberDE: "Bitte geben Sie eine Nummer ein.",
		digits: "Por favor, digite apenas n&uacute;meros.",
		nodigits: "N&atilde;o &eacute; permitida a digita&ccedil;&atilde;o de n&uacute;meros.",
		creditcard: "Please enter a valid credit card.",
		equalTo: "Please enter the same value again.",
		notSelectEqualTo: "Favor selecionar uma op&ccedil;&atilde;o v&aacute;lida.",
		accept: "Please enter a value with a valid extension.",
		maxLength: String.format("Por favor, n&atilde;o entre com um valor com mais de {0} caracteres."),
		minLength: String.format("Por favor, entre com um valor com no m&iacute;nimo {0} caracteres."),
		...
		numeroBrasil: "Por favor, entre com um n&uacute;mero v&aacute;lido."
	},
	...
	methods: {
		...
		notSelectEqualTo: function(value, element, param) {
			return ( value != param );
		},
		...
		date: function(value, element) {
			...
			return this.required(element) || returnval;
		},
		...
		/**
		* N�o permite a entrada de n�meros no campo sendo editado
		*/
		...
		*/
		...
		/**
		*
		* Valida n�meros no formato Brasil (1.000.000,00)
		*
		*/
		numeroBrasil: function(value, element) {
			return this.required(element) || /^-?(?:\d+|\d{1,3}(?:\.\d{3})+)(?:,\d+)?$/.test(value);
		},
